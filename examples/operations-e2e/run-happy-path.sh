...
if [ -z "${SERVICE_TOKEN:-}" ]; then
  ...
  token_json=$(./examples/operations-e2e/create-service-token.sh)
...
table_json=$(./examples/operations-e2e/create-todos-table.sh)
