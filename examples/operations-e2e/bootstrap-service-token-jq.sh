...
echo './examples/operations-e2e/get-events-checkpoint.sh'
echo 'export LAST_EVENT_ID=<checkpoint_id>'
echo './examples/operations-e2e/replay-todo-events.sh'
echo './examples/operations-e2e/import-todos-table.sh'
